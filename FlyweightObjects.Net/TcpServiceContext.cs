...
namespace FlyweightObjects
{
	...
	/// </summary>
	public abstract class TcpServiceContext : ServiceContextBase
	{
		/// <summary>
		...
		public TcpServiceContext(string connectionString, StorageProviderType providerType)
		...
		public TcpServiceContext(string connectionString, StorageProviderType providerType, bool compressPayloads, bool encryptPayloads)
			: base(connectionString, providerType)
		{
        ...
        public TcpServiceContext(string connectionString, StorageProviderType providerType, bool compressPayloads, byte[] key)
            : base(connectionString, providerType)
        {
        ...
        public TcpServiceContext(Type defaultBusinessLogicType)
        ...
        /// <param name="compressPayloads">Determines whether the message payloads should be compressed.</param>
        /// <param name="encryptPayloads">Determines whether the message payloads should be encrypted.</param>
        public TcpServiceContext(Type defaultBusinessLogicType, bool compressPayloads, bool encryptPayloads)
            : base(defaultBusinessLogicType)
        {
            base.CompressPayloads = compressPayloads;
            base.EncryptPayloads = encryptPayloads;
