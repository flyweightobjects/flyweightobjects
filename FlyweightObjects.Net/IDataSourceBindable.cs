...
{
    /// <summary>
    /// Provides custom binding of data for an object.
    /// </summary>
    public interface IDataSourceBindable
    {
        ...
        /// </summary>
        /// <param name="source">The data source from which to bind the object members.</param>
        void BindData(IDataSource source);
    }
}
