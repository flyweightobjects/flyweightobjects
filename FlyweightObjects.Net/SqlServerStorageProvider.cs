...
namespace FlyweightObjects
{
	...
	/// </summary>
	public class SqlServerStorageProvider : StorageProviderBase, IStorageProvider
	{
		...
		public SqlServerStorageProvider(string connectionString)
			: base(connectionString, StorageProviderType.SqlServer)
		{
        ...
        {
            return new SqlServerQueryBuilder<T>(this).BuildStorageCommand(query);
        }
